...
export const useCargarPlanCuentaStore = defineStore('cargarplancuentaStore',{
    state: () => ({  
        items:[], 
        cabecera: [
          {text:'titulo1',value:'0'},
          {text:'titulo2',value:'1'},
          {text:'titulo3',value:'2'},
          {text:'titulo4',value:'4'},
        ],
        storeArrayExcel: {
          tituloUno:[],
          tituloDos:[],
  ...
  try{
     ...
     async subirExcel(entrada){
      try{
        ...
        // readXlsFile(entrada, {map}).then(({rows}) => {
            // this.storeArrayExcel.tituloUno=rows.titulo_1
            // this.storeArrayExcel.tituloDos=rows.titulo_2
            // this.storeArrayExcel.tituloTres=rows.titulo3
            // this.storeArrayExcel.tituloCuatro=rows.titulo4
          readXlsFile(entrada.files[0]).then((rows) => {
          this.items = rows;
          // this.storeArrayExcel = rows;
          // rows === [{
          //   this.storeArrayExcel.tituloUno= map.titulo1,
          //   titulo_2: 'dos',
          //   titulo_3: 'tres',
          //   titulo_4: 'cuatro'
          //   }]          
