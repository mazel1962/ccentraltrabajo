<template>
    <div id="appperiodos" class="container">
        ...
        <br><br>
        <label font-bold >Año Periodo</label>&nbsp&nbsp&nbsp
        <input id="idano" type="text" size = "6" bg-sky-900 v-model="anoperiodo" maxlength = "20" style="text-transform:uppercase;" @change="funcionvalidarclasificacion()">&nbsp
        ...
        <br><br>
	      ...
	      <th>SISTEMAS&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
	      <th>Enero&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
	      <th>Febrero&nbsp&nbsp&nbsp&nbsp&nbsp</th>
	      <th>Marzo&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
        <th>Abril&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
        <th>Mayo&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
        <th>Junio&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
        <th>Julio&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
        <th>Agosto&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
        <th>Septiembre&nbsp&nbsp&nbsp&nbsp&nbsp</th>
        <th>Octubre&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
        <th>Noviembre&nbsp&nbsp&nbsp&nbsp&nbsp</th>
        <th>Diciembre&nbsp&nbsp&nbsp&nbsp&nbsp</th>
  	...
  	<tr >
        ...
        <label for="idenero">Enero</label>&nbsp
        <input id="idenero" v-model="clasificacionStore.storeInactividad" type="checkbox" unchecked>
        <label for="idfebrero">Febrero</label>&nbsp
        <input id="idfebrero" v-model="clasificacionStore.storeInactividad" type="checkbox" unchecked>
